...
async function main() {
  ...
  console.log(`shibuya: ${counter_token.target}`);
  ...
  try {
    ...
    console.log("Contract verified to", hre.config.etherscan.customChains[0].urls.browserURL + "/address/" + counter_token.target);
  } catch (err) {
